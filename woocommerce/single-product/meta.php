...
$is_boxers = has_term( array( 'boxerky','orto-bokserice', 'bokserice-sastavi-paket', 'bokserice', 'mpoxerakia', 'boxers', 'boxerakia' ), 'product_cat', $current_product_id ) && ! has_term( array( 'black-friday', 'majice-i-bokserice-paketi' ), 'product_cat', $current_product_id );

$is_carape = has_term( array( 'ponozky', 'zimske-carape', 'kaltses', 'socks' ), 'product_cat', $current_product_id );

$is_mixed_bundle = has_term( array( 'black-friday', 'sady', 'orto-starter', 'orto-majica-bokserica', 'set', 'seta', 'bundles', 'paketo-ekkinisis' ), 'product_cat', $current_product_id );
...
<br>
     ...
     <div class="accordion-item">
      ...
      <div class="accordion-content">
          ...
          <img src="https://noriks.com/gr/wp-content/uploads/2026/01/boxers_size_GR.png">
        ...
        <?php elseif(  $is_carape ): ?>
                  ...
                  <img src="https://noriks.com/gr/wp-content/uploads/2026/01/Nogavice_tabela_velikosti_GR.png">
