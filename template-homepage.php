...
get_header(); ?>
  ...
  <div class="hero__media" aria-hidden="true">
    ...
    <img
      src="/lv/wp-content/themes/noriks/img/noriks-hero.jpeg"
      alt=""
    />
  </div>
...
@media (max-width: 640px) {
  ...
  <div class="collections__header">
    <h2 class="collections__title">Iepirkties pēc kolekcijas</h2>

    <a class="collections__cta" href="/lv/shop">
      Visi produkti <span aria-hidden="true">›</span>
    </a>
  </div>

  <div class="collections__grid">
    <!-- Card 1 -->
    <a class="collection-card" href="/lv/shop/?filter_product_cat=t-shirts">
      <div class="collection-card__media">
        <img
          src="/lv/wp-content/themes/noriks/img/noriks-majice.jpeg"
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">T-krekli</h3>
          </div>
          <p class="collection-card__desc">
Komforts visu dienu. Bez vilkšanas.
          </p>
        </div>
    ...
    <!-- Card 2 -->
    <a class="collection-card" href="/lv/shop/?filter_product_cat=boxers">
      <div class="collection-card__media">
        <img
          src="/lv/wp-content/themes/noriks/img/noriks-boksarice.jpeg"
          alt="V-neck t-shirt"
        />
      </div>
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Bokseršorti</h3>
          </div>
          <p class="collection-card__desc">
   Mīksti. Elpojami. Uzticami.
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="/lv/product-category/bundles/">
      <div class="collection-card__media">
        <img
          src="/lv/wp-content/themes/noriks/img/noriks-kompleti.jpeg"
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Komplekti</h3>
       
          </div>
          <p class="collection-card__desc">
Labākā cenas un kvalitātes attiecība komplektā.
          </p>
        </div>
    ...
    <!-- Card 4 - Starter Pack -->
    <a class="collection-card" href="/lv/shop/?filter_product_cat=starter-pack">
      <div class="collection-card__media">
        <img
          src="/lv/wp-content/themes/noriks/img/starter-paket_.jpeg"
          alt="Long sleeve shirt"
        />
      </div>
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Starta komplekts</h3>
           
           
          </div>
          <p class="collection-card__desc">
Izmēģini NORIKS izdevīgāk.
