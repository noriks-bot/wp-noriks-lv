        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php if ($i === 0): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="/lv/shop">Izveidojiet savu komplektu</a>
                        <a href="/lv/product-category/tricka/">Gatavi komplekti</a>
                    </div>
                    -->
                </div>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/lv/product-category/boxerky-sastavi-paket/">Izveidojiet savu komplektu</a>
                        <a href="/lv/product-category/boxerky/">Gatavi komplekti</a>
                    </div>
                    -->
                </div>
