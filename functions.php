...
add_action('init', function () {
	...
	add_filter('woocommerce_add_to_cart_redirect', function ($url) {
		return home_url('/lv/cart/'); // or wc_get_cart_url()
	}, 9999);
});
...
} else if ($webshop_language == "LV") {
  include(get_template_directory() . '/functions/lang/lv.php');
}
// Default to Latvian for this store
include(get_template_directory() . '/functions/lang/lv.php');
/*  include language specific files */
